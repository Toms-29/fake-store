...
export const ProductName = z.string().trim().nonempty("Product name is required").min(3).max(100).regex(/^[\p{L}\p{N}\s._-]+$/u, "Solo letras, números, guiones y guiones bajos")
